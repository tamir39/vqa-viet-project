...
> **Phase-1 status (2026-05).** The Phase-1 corpus is already shipped on HuggingFace Hub as [`Tamir39/foodlensvn`](https://huggingface.co/datasets/Tamir39/foodlensvn) (5,572 rows, 20 dishes, sentence-style answers generated by Gemini). This guide remains the spec for **any future manual annotation** (e.g. error-fix passes, Phase-6 DPO preference pairs). Don't re-annotate Phase-1 rows.
